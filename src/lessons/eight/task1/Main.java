...
public class Main {
    ...
    public static void main(String[] args) {
        Tree tree = new Tree(new Node(0,null,null, new AtomicBoolean()));
        ...
        LogThread logThread = new LogThread(tree.root, tree.root.builder);
        ThreadWork threadWork = new ThreadWork(tree.root, new File("log.txt"));
