...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Node node = new Node(1, "first", new AtomicBoolean(), new Node(2, "secondLeft", new AtomicBoolean(), null, null, stringBuilder), new Node(3,"secondRight", new AtomicBoolean(), null, null, stringBuilder), stringBuilder);
